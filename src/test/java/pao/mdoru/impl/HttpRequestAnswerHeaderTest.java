 ...
 */
public class HttpRequestAnswerHeaderTest {
    private String answer = "HTTP/1.1 404 Not Found\n" +
            "Content-Type: text/html; charset=UTF-8\n" +
            "Content-Length: 1562\n" +
            "Date: Mon, 02 May 2016 09:18:59 GMT\n" +
            "\n" +
            "<!DOCTYPE html>\n" +
            "<html lang=en>\n" +
            "  <meta charset=utf-8>\n" +
            ...
            "  <p>The requested URL <code>/l</code> was not found on this server.  <ins>That’s all we know.</ins>";

    @Test
    public void parseHeader() throws Exception {
        HttpRequestAnswerHeader header = new HttpRequestAnswerHeader();
